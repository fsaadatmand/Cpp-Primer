...
/*
 * Note: to allow an optional second argument, resize uses
 * the default constructor of T to initialize arg.
 *
 *	T arg = T()
 *
 * for example, if T is int, then the above expression will generate
 *
 * 	int arg = int()
 */
